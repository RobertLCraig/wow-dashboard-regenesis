        ...
        <div x-data="{ explain: false }">
            ...
            <x-explainer-panel title="Reading this log">
                <p>
                    ...
                    boss's remaining HP at the moment the pull ended). Hit
                    <span class="inline-flex w-3.5 h-3.5 items-center justify-center rounded-full border border-line text-[9px] font-semibold align-middle">?</span>
                                ...
                                <tr class="text-left text-xs uppercase tracking-wider text-muted">
                                    <th class="px-5 py-2 font-medium">
                                        <span class="inline-flex items-center gap-1.5">
                                            <span class="cursor-pointer select-none hover:text-ink"
                                                  @click="sortBy('player')">
                                                Player <span class="text-muted" x-text="sortIcon('player')"></span>
                                            </span>
                                            <x-info-popover title="Player" align="left">
                                    ...
                                    <th class="px-2 py-2 font-medium">
                                        <span class="inline-flex items-center gap-1.5">
                                            ...
                                            <x-info-popover title="Role">
                                                ...
                                                otherwise inferred by comparing damage and healing output.
                                            </x-info-popover>
                                        </span>
                                    </th>
                                    <th class="px-2 py-2 font-medium text-right">
                                        <span class="inline-flex items-center gap-1.5 justify-end">
                                            ...
                                            <x-info-popover title="Per second">
